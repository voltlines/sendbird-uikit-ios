...
public class SBUStringSet: NSObject {
    ...
    public static var Reply = "Yanıtla"
    ...
    public static var MessageInput_Text_Reply = "Mesajı yanıtla"
    public static var MessageInput_Reply_To: (String) -> String = { _ in
        return "Mesajı yanıtlayın"
    }
    public static var MessageInput_Quote_Message_Photo = "Fotoğraf"
    ...
    public static var Message_Replied_To: (String, String) -> String = { _, _ in
        return "Mesaj yanıtlandı"
    }
    public static var Message_You = "Siz"


    // MARK: - Empty
    public static var Empty_No_Channels = "Çok Yakında..."
